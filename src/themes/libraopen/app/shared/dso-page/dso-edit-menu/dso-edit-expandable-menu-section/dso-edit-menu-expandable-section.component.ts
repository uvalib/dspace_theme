...
import { AbstractMenuSectionComponent } from '../../../../../../../app/shared/menu/menu-section/abstract-menu-section.component';
...
/**
 * Represents an expandable section in the dso edit menus (LibraOpen theme).
 */
@Component({
