...
// LibraOpen: override getComponentForMenuItemType to use the theme text-menu-item.component
import { getComponentForMenuItemType } from '../menu-item/menu-item.decorator';
import { MenuItemModel } from '../../../../../../../src/app/shared/menu/menu-item/models/menu-item.model';
 ...
 */
@Component({
  selector: 'ds-themed-menu-section',
  template: '',
  standalone: true,
})
